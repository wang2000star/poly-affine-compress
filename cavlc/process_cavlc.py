...
def main():
    ...
    print("预处理 XOR 模式...")
    text = open('/home/wangfz/bool/cavlc/cavlc.txt').read()
    text = re.sub(
    ...
    # Write files
    with open(f"{out_dir}/cavlc/cavlc_opt1.poly", 'w', encoding='utf-8') as f:
        f.write('\n'.join(lines1))
    print(f"\n  → cavlc/cavlc_opt1.poly")

    with open(f"{out_dir}/cavlc/cavlc_opt2.poly", 'w', encoding='utf-8') as f:
        f.write('\n'.join(lines2))
    print(f"  → cavlc/cavlc_opt2.poly")
